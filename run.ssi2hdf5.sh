...
OUTFILE=/global/cscratch1/sd/houhun/stripe_large/surface-800-100.ssi.h5

date

source activate myenv

stdbuf -o0 -e0 -i0 srun -N 16 -n 119 python /global/u1/h/houhun/sw4essi_converter/ssi2sachdf5.py -i $INFILE -o $OUTFILE  -x 1000 120000 -y 1000 80000 -s 1000 -v
